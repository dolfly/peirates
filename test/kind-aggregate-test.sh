...
# in exact 19-entry parity, and the intentionally retained manual harness must
...
echo "Kind aggregate cleanup and 19/19/19 inventory regression tests passed"
