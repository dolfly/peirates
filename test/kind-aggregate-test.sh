...
# in exact 18-entry parity, and the intentionally retained manual harness must
...
echo "Kind aggregate cleanup and 18/18/18 inventory regression tests passed"
